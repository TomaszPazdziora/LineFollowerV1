...
void MX_FREERTOS_Init(void) {
  ...
  /* definition and creation of CommSemaphore */
  osSemaphoreDef(CommSemaphore);
  CommSemaphoreHandle = osSemaphoreCreate(osSemaphore(CommSemaphore), 1);
  ...
  osThreadDef(driveTask, StartDriveTask, osPriorityNormal, 0, 1024);
